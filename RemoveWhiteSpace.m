function u_out = RemoveWhiteSpace(u_in, X)
...
%
ystart = boundingbox_vert(1);
ysize = boundingbox_vert(2)-boundingbox_vert(1);
xstart = boundingbox_hori(1);
xsize =  boundingbox_hori(2)- boundingbox_hori(1);
